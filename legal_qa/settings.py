...
# This is so that the messages can be mapped to a Bootstrap 5 class,
# for example: alert-{{ messages.error }} --> alert-danger
#
# Note that messages.success/info/warning already map correctly by default.
MESSAGE_TAGS = {
